...
do {
    ...
    T.eq("sanitize single", DailyNotes.sanitizeDiariesRelativePath("journal"), "journal")
    T.eq("sanitize reject nested", DailyNotes.sanitizeDiariesRelativePath("notes/daily"), Optional<String>.none)
    T.eq("sanitize reject diaries/diaries", DailyNotes.sanitizeDiariesRelativePath("diaries/diaries"), Optional<String>.none)
